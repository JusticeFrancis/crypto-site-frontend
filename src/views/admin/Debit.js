...
export default function Debit(props) {
    ...
    const approveTransaction = async(transaction_id, email)=>{
        ...
        const requestOptions = {
            ...
            body : JSON.stringify({ transaction_id : transaction_id, admin : user.email, email : email, type : 'debit'})
        };
    ...
    const getTransactions = async()=>{
        ...
        const response = await fetch(backend+'/admin/transactions/debit', requestOptions)
        const res = await response.json()
                       ...
                       <h3 style={{ fontWeight:'bolder' }}>Credit Transactions</h3>
                        ...
                        <table className="items-center w-full bg-transparent border-collapse">
                            ...
                            (
                                ...
                                {data.status === '1' ? (
                                    <div><i className="fas fa-circle text-blue-500 mr-2" style={{color : 'green'}}></i>approved</div>
                                ) :  null}
